...
if __name__ == "__main__":
    # Example usage:
    # For local files: result = create_enhanced_merged_dataset(local_path="/path/to/csv/files")
    # For Hugging Face: result = create_enhanced_merged_dataset()
    
    # Create the enhanced merged dataset
    result = create_enhanced_merged_dataset(local_path="/home/vagrant/PublicRepos/25-07-09-MER2025")
    
    # Extract the data structures
    enhanced_merged_by_name = result['enhanced_merged_by_name']
    merged_by_name = result['merged_by_name']
    subtitle_by_name = result['subtitle_by_name']
    ...
    print(f"✅ Available data structures:")
    print(f"  - enhanced_merged_by_name: {len(enhanced_merged_by_name)} entries")
    print(f"  - merged_by_name: {len(merged_by_name)} entries")
    print(f"  - subtitle_by_name: {len(subtitle_by_name)} entries")
    print(f"  - datasets: {len(datasets)} individual datasets")
    
    # Make data globally accessible for interactive use
    globals().update({
        'enhanced_merged_by_name': enhanced_merged_by_name,
        'merged_by_name': merged_by_name,
        'subtitle_by_name': subtitle_by_name,
    ...
    print(f"\n🎯 All data structures are now globally accessible!")
    print(f"You can now use: enhanced_merged_by_name, merged_by_name, subtitle_by_name, datasets")
